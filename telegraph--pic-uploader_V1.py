...
def bianli_pics(path):
    ...
    img_folder = path
    img_list = [os.path.join(nm) for nm in os.listdir(img_folder) if nm[-3:].lower() in ['jpg', 'png', 'gif','JPG']]
...
while (1):
    ...
    # Hello_Kris
    # print("html content:")
    html_text = ' <p>Here are some pics. Enjoy!</p>  ' or input()
    # <p>Here are some pics. Enjoy!</p>  
    # try:
    html_imgs = bianli_pics(folder)
    print('html_imgs : '+html_imgs)
